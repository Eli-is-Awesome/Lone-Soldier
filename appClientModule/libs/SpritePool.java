...
public abstract class SpritePool
{
	...
	private static LinkedList<SpritePoolObject> spritePoolOutList;
	...
	public void checkIn( SpritePoolObject obj )
	{
		...
		if( spritePoolInList.size() >= poolSize )
		{
			do
			{
				spritePoolInList.remove();
			} while( spritePoolInList.size() >= 5 );
		}
		if( poolWait )
		{
