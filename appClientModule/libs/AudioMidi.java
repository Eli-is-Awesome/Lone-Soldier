...
public class AudioMidi implements MetaEventListener
{
	 ...
	 */
	public AudioMidi( Object obj, String filename )
	 ...
	 * @throws MidiUnavailableException
	 */
	public AudioMidi( URL audioURL ) throws InvalidMidiDataException,
	...
	{
		int index;
		int midiBalance = ( int ) ( ( range + 1.0 ) * 127.0 / 2.0 );
		...
		else
		{
			...
			{
				volumeMessage.setMessage( ShortMessage.CONTROL_CHANGE, index,
						BALANCE_CONTROLLER, midiBalance );
	...
	{
		int index;
		int midiPan = ( int ) ( ( range + 1.0 ) * 127.0 / 2.0 );
	 ...
	 * @throws InvalidMidiDataException
	 */
	public void setVolume( double volume ) throws MidiUnavailableException,
			InvalidMidiDataException
	{
		int index;
		int midiVolume = ( int ) ( ( volume / 11.0 ) * 127 );
	 ...
	 * 
	 */
	private void load() throws InvalidMidiDataException, IOException,
			MidiUnavailableException
	{
		/**
