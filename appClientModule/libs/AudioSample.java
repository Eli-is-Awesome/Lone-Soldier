...
public class AudioSample implements LineListener
{
	 ...
	 */
	public AudioSample( Object obj, String filename ) throws IOException,
	 ...
	 * @throws UnsupportedAudioFileException
	 */
	public AudioSample( URL audioURL ) throws UnsupportedAudioFileException,
			...
			LineUnavailableException
	{
		...
		DataLine.Info info = new DataLine.Info( Clip.class, audioFormat,
				( ( int ) audioStream.getFrameLength() * audioFormat
						.getFrameSize() ) );
