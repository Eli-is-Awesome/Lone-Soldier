...
public class TileSheet
{
	...
	public TileSheet( BufferedImage image, int tileWidth, int tileHeight )
	{
				...
				|| ( image.getWidth() % tileWidth ) != 0 )
		{
			throw new RuntimeException(
					"Image dimensions do not match the tile width and height" );
		}
	}
	 ...
	 * @throws IOException
	 */
	public TileSheet( Object obj, String file, int tileWidth, int tileHeight )
			throws IOException
	{
		this.tileWidth = tileWidth;
		this.tileHeight = tileHeight;
	...
	{
		return image.getSubimage( ( column * tileWidth ), ( row * tileHeight ),
