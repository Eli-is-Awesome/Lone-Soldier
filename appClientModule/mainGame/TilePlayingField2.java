...
public class TilePlayingField2 extends PlayingField
{
	/**
	...
	public TilePlayingField2() throws IOException
	{
		...
		buildings = ImageUtil.loadBufferedImage( this,
				"images/level_2_Buildings.png" );
		foreground = ImageUtil.loadBufferedImage( this,
				"images/level_2_Foreground.png" );
		...
		short[][] tempMap = MapFile.readMap( this, "images/level_2_Main.txt" );
		short[][] tempMap2 = MapFile.readMap( this,
				"images/level_2_FakeTiles.txt" );
		if( tempMap != null )
		{
			fieldMap = tempMap;
		}
	...
	public void drawFront( Graphics2D g )
	{
		...
		g.drawImage( foreground.getSubimage( gameDisplayXPos, gameDisplayYPos,
				( int ) displayBounds.getWidth(),
				( int ) displayBounds.getHeight() ), 0, 3, null );
	}
	...
	public boolean isCollision( double x, double y )
	{
		...
		{
			if( Telepath.isDead() == true )
			{
				flag = true;
			}
			if( Telepath.isDead() == false )
			{
				flag = false;
			}
